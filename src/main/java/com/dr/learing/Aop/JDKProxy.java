...
public class JDKProxy implements InvocationHandler {
  /*  @Override public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
    ...
    public Object newProxy(Object targetObject) {//将目标对象传入进行代理
        ...
        return object;
        /*
         注意这里上面这个方法传入的参数是接口，而且用的是class.getClass().getInterfaces()
         和class.getClass().getClassLoader(),所以是在这里用了反射。

        JDK的动态代理是靠多态和反射来实现的，它生成的代理类需要实现你传入的接口，并通过反射来得到接口的方法对象（下文中的m3），
    ...
    public Object invoke(Object proxy, Method method, Object[] args)//invoke方法
        ...
        ret  = method.invoke(targetObject, args);       //调用invoke方法，ret存储该方法的返回值,通过反射获取代理方法然后进行调用，而在cglib中则是直接调用的，因为继承的缘故
        return ret;
    }
