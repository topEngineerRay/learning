...
public class Main {
    ...
    public static void main(String[] args) throws Routes.NoSuchRouteException {
      ...
      */
       ...
       System.out.println("Output#2  " + graph.findDistanceBetweenTowns(routes2));
        ...
        System.out.println("Output#6  " + graph.findRoutesCountLessThanLimit(c,c,3));

        //7. Number of trips starting at A,ending at C with 4 stops max
        System.out.println("Output#7  " + graph.findRoutesWithExactStop(a,c,4));
