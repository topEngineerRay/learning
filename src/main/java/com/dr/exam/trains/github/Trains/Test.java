package com.dr.exam.trains.github.Trains;///**
//  Testing out the graph problem,
//  This should ideally be a JUnit test but i ran out of time,
//  and also this is my first java application in 4years!
//*/
...
public class Test{
  ...
  // }
      ...
      }catch (Routes.NoSuchRouteException exception){
