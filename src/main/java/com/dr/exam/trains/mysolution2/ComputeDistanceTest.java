...
public class ComputeDistanceTest {
    ...
    */
    ...
    public void prepareGraph(){
        computeDistanceUtil= new ComputeDistanceUtil();
        computeDistanceUtil.addTown(townA);
        computeDistanceUtil.addTown(townB);
        computeDistanceUtil.addTown(townC);
        computeDistanceUtil.addTown(townD);
        computeDistanceUtil.addTown(townE);

        computeDistanceUtil.addRoute("A",routeAB);
        computeDistanceUtil.addRoute("B",routeBC);
        computeDistanceUtil.addRoute("C",routeCD);
        computeDistanceUtil.addRoute("D",routeDC);
        computeDistanceUtil.addRoute("D",routeDE);
        computeDistanceUtil.addRoute("A",routeAD);
        computeDistanceUtil.addRoute("C",routeCE);
        computeDistanceUtil.addRoute("E",routeEB);
        computeDistanceUtil.addRoute("A",routeAE);
    ...
    public void testABC(){
        ...
        townList.add(townA.getTownName());
        townList.add(townB.getTownName());
        townList.add(townC.getTownName());
    ...
    public void testAD(){
        ...
        List<String> townList = new ArrayList();
        townList.add(townA.getTownName());
        townList.add(townD.getTownName());
    ...
    public void testAEBCD(){
        ...
        List<String> townList = new ArrayList();
        townList.add(townA.getTownName());
        townList.add(townE.getTownName());
        townList.add(townB.getTownName());
        townList.add(townC.getTownName());
        townList.add(townD.getTownName());
    ...
    public void testCCWithLessThan4StopsTripCount(){
        ...
        int actualTripsCount =  computeDistanceUtil.calculateTripCountsWithLessThan4Stops(townC,townC,3);
    ...
    public void testACWith4StopsTripCount(){
        ...
        int actualTripsCount =  computeDistanceUtil.calculateDistanceWith4Stops(townA,townC,4);
    ...
    public void testACShortestRoute(){
        int expectedOutput = 9;
        int actualTripsCount =  computeDistanceUtil.findShortestRoute(townA,townC);
    ...
    public void testBBShortestRoute(){
        int expectedOutput = 9;
        int actualTripsCount =  computeDistanceUtil.findShortestRoute(townB,townB);
    ...
    public void testCCLessthan30TripCount(){
      /*  int expectedOutput = 7;
        int actualTripsCount =  computeDistanceUtil.findShortestRoute(townC.getTownName(),townC.getTownName(),30);
